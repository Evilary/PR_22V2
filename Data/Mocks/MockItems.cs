            ...
            get
            {
                return new List<Items>()
                {
                    new Items()
                    {
                        ...
                        Img = "https://indexiq.ru/storage/photo/resized/xy_1200x1200/c/a591zzxhsfb9ylz_aecfa4b.jpg.webp",
                        Price = 60990,
                        Categorys = _category.AllCategorys.Where(x => x.Id == 1).First()
                    },
                    new Items()
                    {
                        Id = 0,
                        ...
                        Price = 3229,
                        Categorys = _category.AllCategorys.Where(x => x.Id == 2).First()
                    }
